...
echo -e "\n==== Copying files to Pi ====\n"
rsync -av -e "ssh -o StrictHostKeyChecking=no -i ~/.ssh/id_ed25519" --delete --exclude={'.git','.gitignore','id_ed25519*','commands.txt','images','README.md'} "$(pwd)" "$USER"@"$PI_HOST":/home/"$USER"
